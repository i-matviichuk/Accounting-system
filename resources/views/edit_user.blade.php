                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form id="form1" class="form-horizontal" method="POST"
                                    ...
                                    @if($user->group_id != NULL)
                                        <p><select class="form-control" name="group_number">
                                                ...
                                                @foreach($groups as $group)
                                                    <option value="{{ $group->id }}" {{ $group->group_number == $user->group->group_number ? " selected" : "" }}>{{$group->group_number}}</option>
                                                @endforeach
                                            </select></p>
                            ...
                            <input type="checkbox" name="show_pass_field" value="show_pass_field" id="show_pass"
                                   onchange='showOrHide("show_pass", "pass_form")'> Змінити пароль</input>
                            <div id="pass_form">
                                ...
                                <div class="form-group">
                                    <label for="password-confirm" class="col-md-4 control-label">Повторіть
                                        пароль</label>
