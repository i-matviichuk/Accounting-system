...
Route::get('/mark/{mark}/edit/{group}', 'MarkController@editMark')->name('editMark');
Route::post('/mark/{mark}/edit/{group}', 'MarkController@updateMark')->name('updateMark');
Route::get('/mark/{mark}/{group}', 'MarkController@deleteMark')->name('deleteMark')->middleware('can:delete,mark');

Route::get('/group/{group}/add/visiting', 'VisitingController@showForm')->name('showAddVisiting');
Route::post('/group/{group}/add/visiting', 'VisitingController@addVisiting')->name('addVisiting');
...
Route::get('/users/{user}/delete', 'UserController@deleteUser')->name('deleteUser')->middleware('can:delete,user');
